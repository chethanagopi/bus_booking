...
app = Flask(__name__)
# app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:Pavan6458@localhost:3306/chethana'
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://chethana:Pavan6458@localhost:3306/chethana'
